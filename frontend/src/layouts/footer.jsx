...
const Footer = () => {
  return (
    <footer className="bg-gray-700 text-white pt-10 pb-5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4" style={{color: 'var(--main-color)'}}>WAAREE</h3>
            <p className="mb-4 text-gray-300">
              Your one-stop shop for all your shopping needs. Quality products, fast delivery, and excellent customer service.
            </p>
