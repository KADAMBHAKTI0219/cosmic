        ...
        <div className="p-3 sm:p-4">
          <div className="relative">
            <input
              type="text"
              placeholder="Search..."
              className="w-full border border-gray-300 rounded-md py-1.5 sm:py-2 px-3 sm:px-4 text-sm focus:outline-none focus:ring-2 focus:ring-main focus:border-transparent"
            />
