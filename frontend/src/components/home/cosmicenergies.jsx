    ...
    <div className="w-full bg-gray-50 py-8 sm:py-10 md:py-12 px-3 sm:px-4 md:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-6">
          Waaree Energies – Built On Scale, Driven By Quality
        </h2>
        
        <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-10 md:mb-12 px-2 sm:px-4">
          <p className="text-sm sm:text-base md:text-lg text-gray-700">
            With ~ 16.7 GW global solar panel manufacturing capacity and 5.4 GW solar cell manufacturing capacity, Waaree Energies is proud to lead India's solar revolution. Our state-of-the-art facilities in India and the USA ensure every product meets the highest standards of efficiency, durability, and reliability.
          </p>
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mt-3 sm:mt-4">
            Every panel and cell undergoes rigorous quality testing, and our customer-first approach ensures smooth service from consultation to installation. Trusted worldwide, Waaree delivers solar solutions that perform — today and for years to come. Choose Waaree for high-quality solar solutions trusted by businesses and homeowners worldwide.
          </p>
        </div>
